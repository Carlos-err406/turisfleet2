...
export async function POST<T>(url: string, body: BodyInit | null | undefined, searchParams = '') {
...
export async function PUT<T>(url: string, body: BodyInit | null | undefined, searchParams = '') {
	const headers = new Headers();
...
export async function PATCH<T>(url: string, body: BodyInit | null | undefined, searchParams = '') {
	const headers = new Headers();
